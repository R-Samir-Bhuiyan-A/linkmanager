...
import { Save, Bell, Shield, Database, Globe, Sliders, Server, Lock, CheckCircle, XCircle } from 'lucide-react';
...
export default function Settings() {
    ...
    const tabs = ['General', 'Security', 'SMTP Configuration', 'Backups'];
    ...
    return (
        <PageTransition>
            <div className="flex items-center justify-between mb-8">
                ...
                <button onClick={handleSave} className="flex items-center gap-2 px-4 py-2 bg-violet-600 hover:bg-violet-500 text-white rounded-lg font-bold shadow-lg shadow-violet-500/20 transition-all">
